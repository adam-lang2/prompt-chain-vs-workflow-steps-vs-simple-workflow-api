"""Session-wide pass/fail accounting, by (agent, scenario), across every
scripted-suite run this session -- the counterpart to `token_tracking.py`
...
def record_result(agent_id: str, scenario_name: str, score: WorkflowScore) -> None:
    _RESULTS.append(
        ScenarioResult(
            agent_id=agent_id,
